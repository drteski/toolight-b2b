      ...
      tabs: [
        ...
        },
        {
          ...
          fields: [
            {
              name: 'notFound',
              label: 'Tekst nie znaleziono strony',
              type: 'text',
              localized: true,
              defaultValue: '---',
            },
            {
              name: 'defaultCategoryPage',
              type: 'relationship',
